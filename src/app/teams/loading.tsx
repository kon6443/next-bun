    ...
    >
      <main className="relative z-10 mx-auto flex max-w-5xl flex-col gap-6 sm:gap-10 px-4 pb-24 pt-12 sm:pt-16 sm:px-8">
        <section className="rounded-3xl border border-white/10 bg-slate-900/80 p-4 sm:p-8">
          <p className="text-xs uppercase tracking-[0.7em] text-slate-400">Teams</p>
          <div className="mt-4">
            <h1 className="text-3xl font-bold text-white sm:text-4xl">내가 속한 팀</h1>
          </div>
        </section>
        ...
        <section className="rounded-3xl border border-white/10 bg-slate-900/80 p-4 sm:p-8">
          <div className="rounded-2xl border border-dashed border-white/20 px-6 py-14 text-center">
            ...
            <p className="mt-4 text-base font-semibold text-white">로딩 중...</p>
          </div>
        </section>
      </main>
    </div>
