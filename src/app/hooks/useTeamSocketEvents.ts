...
export function useTeamSocketEvents(
  ...
  useEffect(() => {
    ...
    const handleMemberRoleChanged = (payload: MemberRoleChangedPayload) => {
      if (isSelfTriggered(payload.changedBy)) return;
